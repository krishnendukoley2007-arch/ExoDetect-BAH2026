...
**Fix:
increase "Sectors to stack" in the sidebar to 3–5 try to reduce the minimum period and increase the maximum period and such that the BLS power gets over 50 and re-run the analysis .
---
