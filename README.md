...
│  Narrow search ±3% over known period     │
├──────────────────────────────────────────┤
...
**Model gives wrong classification** — Check the SNR; if below 5, the signal is too weak to classify reliably. Try stacking more sectors.
